...
@Component
public class CalendarNoImageRenderStrategy extends AbstractPdfRenderStrategy {

    private final PdfCalendarRenderer pdfCalendarRenderer;

    public CalendarNoImageRenderStrategy(ExerciseJpaRepository exerciseRepository,
    ...
    public boolean supports(PdfFormatType formatType) {
        return formatType == PdfFormatType.CALENDAR_NO_IMAGE;
    }
    ...
    protected void renderContent(
        ...
        pdfCalendarRenderer.renderCalendar(document, request, exerciseMap, false);
    }
}
